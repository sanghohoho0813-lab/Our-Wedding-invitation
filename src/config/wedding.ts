...
export const wedding = {
    ...
    qa: [
      ...
      },
      {
        ...
        answers: [
          {
            who: "groom",
            text: "야무지고 똑 부러지는데, 사람들에게 잘 맞춰주고 리액션도 좋았어요. 무엇보다 밝았습니다. 곁에 있는 사람에게 좋은 에너지를 주는 사람이구나 싶었어요.",
          },
          {
            who: "bride",
      ...
      },
      {
        ...
        answers: [
          {
            who: "groom",
            text: "저에게 절대 없어서는 안 될, 세상에서 가장 소중한 사람이요. 힘들 때도 기쁠 때도 가장 먼저 떠오르고, 모든 순간을 함께하고 싶은 사람입니다.",
          },
          {
            who: "bride",
      ...
      },
      {
        ...
        answers: [
          {
            who: "groom",
            text: "날씨 좋은 날, 나들이 가는 차 안이요. 함께 미래를 그리면서 행복한 상상을 하며 떠나는 그 시간이 제일 좋습니다.",
          },
          {
            who: "bride",
      ...
      },
      {
        ...
        answers: [
          {
            who: "groom",
            text: "머리부터 발끝까지 제 이상형이에요. 제가 힘들 때마다 뒤에서 지지해 주고 늘 제 편이 되어 줍니다. 저는 꿈을 꾸며 사는 사람인데, 그 꿈을 이룰 수 있게 방향을 잡아주고 응원해 줘요. 밖에서 아무리 힘든 일이 있어도 집에 와서 지윤이를 보면 다 사라지더라고요. 함께 있을 때가 가장 편안하고 행복합니다.",
          },
          {
            who: "bride",
  ...
  dailyGallery: {
    /** 별도 섹션이 아니라 "우리의 시간" 타임라인 중간에 펼쳐집니다. */
    enabled: true,
    heading: "우리의 일상",
  ...
  /* ── 우리의 시간 ──────────────────────────────────────────
     연인이 된 날부터 결혼까지를 한 흐름으로 보여준다.
     중간(photosAfter 다음)에 그동안 찍은 일상 사진이 펼쳐진다. */
  timeline: {
    enabled: true,
    heading: "우리의 시간",
    ...
    items: [
      ...
      },
      {
        ...
        title: "결혼",
        /**
         * {days} 는 연인이 된 날(togetherTime.startDate)부터 예식일까지의
         * 날수로 자동 치환됩니다. 날짜를 바꾸면 숫자도 알아서 바뀝니다.
         */
        body: "연인이 된 지 {days}일 만에, 이제 부부가 됩니다.",
        highlight: "{days}일",
        image: "",
      },
    ...
    items: [
      {
        ...
        body: [
          ...
          "내일이 또 기다려져.",
          "",
          "앞으로 함께할 50년, 100년 동안에도",
          "지금처럼 매일매일 웃을 수 있도록 해줄게.",
          "",
          "어떠한 상황에서도",
          "항상 날 믿어줘서 정말 고마워 ❤️",
          "",
          "그 믿음에 보답하는 최고의 남편이 될게.",
          "정말 많이 사랑해 ❤️",
        ],
      },
      {
  ...
  location: {
    ...
    transport: [
      ...
      { icon: "bus", label: "버스", lines: ["연세대학교 · 신촌역 정류장에서 하차하세요."] },
      {
        ...
        label: "자가용",
        lines: [
          "내비게이션에 \"연세동문회관예식장\" 을 검색하세요.",
          "연세동문회관으로 입·출차하시면 2시간 무료 주차가 제공됩니다.",
        ],
      },
    ],
  },
